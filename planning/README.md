...
committed copy to drift. Run `just check-planning` to validate every bundle and
decision.
...
- **[changes/](changes/)** — the per-change bundles (`design.md` + `plan.md`,
  or a single `change.md`).
